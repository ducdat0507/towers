let upgrades = {
    ...
    "f2_3": {
        ...
        inv(x) { return x.div(1e150).logBase(1e30).logBase(1.14).floor().max(0); },
    ...
    "f3": {
        ...
        inv(x) { return x.div("e500").logBase(1e10).root(1.25).floor().max(0); },
    ...
    "l1": {
        ...
        inv(x) { return x.div(10).logBase(1.5).floor().max(0); },
    ...
    "l1_1": {
        ...
        inv(x) { return x.div(1000).logBase(2).floor().max(0); },
    ...
    "l2": {
        ...
        inv(x) { return x.div(100).logBase(4).floor().max(0); },
        effect(x) { return EN.pow(2, x); },
    },
}